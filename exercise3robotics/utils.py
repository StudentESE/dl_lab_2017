...
class Options:
    ...
    map_ind = 0
    change_tgt = False
    states_fil = "../data/states.csv"
    labels_fil = "../data/labels.csv"
    ...
    device = "/cpu:0"
    path = "/Users/danielbunzendahl/Downloads/assignment_03/data/network_config/model.ckpt"
    num_filters = 8
    num_units_linear_layer = 8 # seems to work good, idea: 8 neighbour cells to robot
